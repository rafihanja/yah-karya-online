 ...
 * 
 * Catatan: Karena ini adalah file .ts murni, kode JSX di-comment agar Linter tidak marah.
 * Jika Anda menggunakan ini di proyek asli, pastikan ekstensi file Anda adalah .tsx
 */
...
export const EliteHeroSection = () => {
  ...
  */
  ...
  // JSX dikembalikan dalam bentuk string agar valid di file .ts
  return `
